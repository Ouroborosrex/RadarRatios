...
class Transformer(nn.Module):
    ...
    def __init__(self,device,num_classes = 19, d_model=100, n_head=4, max_len=5000, seq_len=200,
        ...
        self.encoder = Encoder(d_model=d_model,
                               ...
                               details=details,
                               device=device)
        self.classHead = ClassificationHead(seq_len=seq_len,d_model=d_model,details=details,n_classes=num_classes)
